...
class Ui_TreeNotesWin(object):
    def setupUi(self, TreeNotesWin):
        ...
        self.gridLayout.addWidget(self.txtRevNote, 1, 3, 1, 2)
        ...
        self.treeRevNote.setHeaderHidden(True)
        self.treeRevNote.setObjectName("treeRevNote")
        self.treeRevNote.header().setCascadingSectionResizes(True)
        self.gridLayout.addWidget(self.treeRevNote, 1, 0, 1, 3)
    ...
    def retranslateUi(self, TreeNotesWin):
        ...
        TreeNotesWin.setWindowTitle(_translate("TreeNotesWin", "Review Notes"))
