...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.addMail(
            model, "service@github.com", "Your Github Donation", "03/25/2017 02:05 PM"
        )
        self.addMail(
            model, "support@github.com", "Github Projects", "02/02/2017 03:05 PM"
        )
        self.addMail(
            model, "service@phone.com", "Your Phone Bill", "01/01/2017 04:05 PM"
        )
